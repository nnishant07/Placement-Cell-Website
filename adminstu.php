...
<nav>
    ...
    <div class="row">
              <div class="col-sm-3">
                <b>Student Tables Name</b>
              </div>
              <div class="col1">
                <select id="cars" name="Table" value="" required style="width:60%">
                  <option value="stureg">stureg</option>
                <option value="studet">studet</option>
                <option value="stuedu">stuedu</option>
                <option value="stuplaced">stuplaced</option>
                <option value="stuarea">stuarea</option>
              </select>
              </div>
            </div>
        <hr>
  <div class="container">
    ...
    <?php
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // Run the SQL query and display the results in a table
        $query = $_POST['query'];
